...
/obj/item/holotool/Initialize(mapload)
		"screwdriver" = image(icon = 'modular_skyrat/modules/simple_research/researching.dmi', icon_state = "pyramid"),
		"crowbar" = image(icon = 'modular_skyrat/modules/simple_research/researching.dmi', icon_state = "cube"),
		"welder" = image(icon = 'modular_skyrat/modules/simple_research/researching.dmi', icon_state = "sphere"),
		"wrench" = image(icon = 'modular_skyrat/modules/simple_research/researching.dmi', icon_state = "pyramid"),
		"wirecutter" = image(icon = 'modular_skyrat/modules/simple_research/researching.dmi', icon_state = "cube"),
		"multitool" = image(icon = 'modular_skyrat/modules/simple_research/researching.dmi', icon_state = "sphere"),
	. = ..()

/obj/item/holotool/examine(mob/user)
	. = ..()
	. += span_notice("It is currently set to [current_tool ? current_tool.name : "'off'"].")
